...
const getStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  themeText: { color: '#fab1a0', fontSize: 12, fontWeight: '900', letterSpacing: 2 },
  ...
  base: { position: 'absolute', bottom: 0, width: 100, height: 4, backgroundColor: '#fff', left: 0 },
  upright: { position: 'absolute', bottom: 0, left: 20, width: 4, height: 180, backgroundColor: '#fff' },
  topBeam: { position: 'absolute', top: 20, left: 20, width: 100, height: 4, backgroundColor: '#fff' },
  rope: { position: 'absolute', top: 20, left: 116, width: 2, height: 30, backgroundColor: '#f1c40f' },
  head: { position: 'absolute', top: 50, left: 101, width: 30, height: 30, borderRadius: 15, borderWidth: 3, borderColor: '#fff' },
  body: { position: 'absolute', top: 80, left: 115, width: 3, height: 60, backgroundColor: '#fff' },
  leftArm: { position: 'absolute', top: 100, left: 95, width: 20, height: 3, backgroundColor: '#fff', transform: [{ rotate: '-30deg' }] },
  rightArm: { position: 'absolute', top: 100, left: 118, width: 20, height: 3, backgroundColor: '#fff', transform: [{ rotate: '30deg' }] },
  leftLeg: { position: 'absolute', top: 138, left: 100, width: 25, height: 3, backgroundColor: '#fff', transform: [{ rotate: '-45deg' }] },
  rightLeg: { position: 'absolute', top: 138, left: 108, width: 25, height: 3, backgroundColor: '#fff', transform: [{ rotate: '45deg' }] },
  ...
  letterText: { fontSize: 20, fontWeight: '900', color: '#fff', marginBottom: 2 },
  underline: { width: '100%', height: 3, backgroundColor: '#fab1a0', borderRadius: 2 },
  keyboard: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', gap: 8, paddingBottom: 20 },
  key: { width: (SCREEN_WIDTH - 80) / 7, height: 40, backgroundColor: 'rgba(255,255,255,0.1)', borderRadius: radius.sm, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
