...
const getStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  cell: { width: CELL_SIZE, height: CELL_SIZE, borderWidth: 2, borderColor: 'rgba(255,255,255,0.2)', borderRadius: 4, justifyContent: 'center', alignItems: 'center' },
  activeCell: { transform: [{ scale: 1.1 }], borderColor: 'rgba(255,255,255,0.5)' },
  cellText: { fontSize: 32, fontWeight: '900', color: '#fff' },
  keyboard: { width: '100%', gap: 8, paddingBottom: 20 },
  keyboardRow: { flexDirection: 'row', justifyContent: 'center', gap: 6 },
  key: { minWidth: (SCREEN_WIDTH - 80) / 10, height: 50, backgroundColor: 'rgba(255,255,255,0.15)', borderRadius: 4, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 4 },
  wideKey: { minWidth: 50 },
