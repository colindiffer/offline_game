...
const DIFFICULTIES: { key: Difficulty; label: string; desc: string; accentColor: string }[] = [
  { key: 'easy', label: 'Easy', desc: 'Relaxed pace, forgiving gameplay', accentColor: '#4ecca3' },
  { key: 'medium', label: 'Medium', desc: 'Balanced challenge', accentColor: '#f0a500' },
  { key: 'hard', label: 'Hard', desc: 'Test your skills!', accentColor: '#ff4d4d' },
];
        ...
        >
          ...
          >
            <View style={styles.option}>
              ...
              <View style={[styles.dotIcon, { backgroundColor: d.accentColor }]} />
